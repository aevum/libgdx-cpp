...
public:
    ...
    virtual AudioDevice newAudioDevice (int samplingRate, boolean isMono) = 0;
    ...
    virtual AudioRecorder newAudioRecoder (int samplingRate, boolean isMono) = 0;
    ...
    virtual Sound newSound (FileHandle fileHandle) = 0;
    ...
    virtual Music newMusic (FileHandle file) = 0;
};
}

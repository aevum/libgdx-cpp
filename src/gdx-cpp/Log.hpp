...
#define GDX_LOG_LEVEL_DEBUG
#define GDX_LOG_LEVEL_INFO
#define GDX_LOG_LEVEL_ERROR
...
class Log {
public:
    virtual void debug ( const std::string& tag, const std::string& line, const std::string& file, const char* format, ... ) = 0;
    virtual void error ( const std::string& tag, const std::string& line, const std::string& file, const char* format, ... ) = 0;
    virtual void info ( const std::string& tag, const std::string& line, const std::string& file, const char* format, ... ) = 0;
};
}

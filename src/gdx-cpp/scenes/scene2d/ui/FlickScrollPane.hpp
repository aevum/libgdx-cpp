...
public:
    ...
    void scrollHorizontalTo (float scroll);
    float getHorizontalScrollAmount ();
    void scrollVerticalTo (float scroll);
    float getVerticalScrollAmount ();
    void smoothScrollTo (float horizontal,float vertical);
    void smoothScrollTo (float horizontal,float vertical,int duration);

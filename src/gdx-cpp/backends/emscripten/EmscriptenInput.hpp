...
#ifndef GDX_CPP_BACKENDS_EMSCRIPTEN__EMSCRIPTEN_INPUT_HPP
#define GDX_CPP_BACKENDS_EMSCRIPTEN__EMSCRIPTEN_INPUT_HPP
...
class EmscriptenInput : public gdx::Input
{
public:
    EmscriptenInput();
...
#endif // GDX_CPP_BACKENDS_EMSCRIPTEN__EMSCRIPTEN_INPUT_HPP

...
#ifndef GDX_CPP_BACKENDS_EMSCRIPTEN_GLU_HPP
#define GDX_CPP_BACKENDS_EMSCRIPTEN_GLU_HPP
...
class EmscriptenGLU : public gdx::GLU
{
public:
...
#endif // GDX_CPP_BACKENDS_EMSCRIPTEN_GLU_HPP

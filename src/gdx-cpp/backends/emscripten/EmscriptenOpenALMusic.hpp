...
#ifndef EMSCRIPTEN_MUSIC_HPP
#define EMSCRIPTEN_MUSIC_HPP
...
class EmscriptenOpenALMusic : public gdx::Music
{
public:
    EmscriptenOpenALMusic(gdx::scripten::EmscriptenOpenALAudio* _audio, ref_ptr_maker< gdx::FileHandle >::shared_ptr_t file);

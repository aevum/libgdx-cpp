...
#ifndef GDX_CPP_BACKENDS_EMSCRIPTEN__EMSCRIPTEN_APPLICATION_HPP
#define GDX_CPP_BACKENDS_EMSCRIPTEN__EMSCRIPTEN_APPLICATION_HPP
...
class EmscriptenApplication : public Application, public Runnable, public Synchronizable
{
public:
    EmscriptenApplication(gdx::ApplicationListener* listener, const std::string& title,
...
protected:    
    ...
    EmscriptenGraphics* graphics;
    EmscriptenInput* input;
    EmscriptenFiles* files;
...
#endif // GDX_CPP_BACKENDS_EMSCRIPTEN__EMSCRIPTEN_APPLICATION_HPP

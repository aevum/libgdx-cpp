...
#ifndef GDX_CPP_BACKENDS_EMSCRIPTEN_GRAPHICS_HPP
#define GDX_CPP_BACKENDS_EMSCRIPTEN_GRAPHICS_HPP
...
class EmscriptenGraphics : public Graphics
{
...
public:
    EmscriptenGraphics(bool isUseOpenGLES2);
...
#endif // GDX_CPP_BACKENDS_EMSCRIPTEN_GRAPHICS_HPP

...
#ifndef GDX_CPP_BACKENDS_EMSCRIPTEN__EMSCRIPTEN_FILES_HPP
#define GDX_CPP_BACKENDS_EMSCRIPTEN__EMSCRIPTEN_FILES_HPP
...
namespace scripten {
  ...
  class EmscriptenFiles : public gdx::Files
  {
    public:
        //Override
...
#endif // GDX_CPP_BACKENDS_EMSCRIPTEN__EMSCRIPTEN_FILES_HPP

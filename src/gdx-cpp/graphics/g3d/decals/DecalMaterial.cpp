...
bool DecalMaterial::isOpaque () {
    return srcBlendFactor == NO_BLEND;
}

int DecalMaterial::getSrcBlendFactor () {
    return srcBlendFactor;
}

int DecalMaterial::getDstBlendFactor () {
    return dstBlendFactor;
}

bool DecalMaterial::equals (const Object& o) {

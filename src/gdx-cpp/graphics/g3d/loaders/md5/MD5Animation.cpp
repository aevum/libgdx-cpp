...
void MD5Animation::write (const DataOutputStream& out) throws IOException {
    out.writeUTF(name);
...
void MD5Animation::read (const DataInputStream& in) throws IOException {
    name = in.readUTF();
...
void MD5Animation::interpolate (const MD5Joints& skeletonA,const MD5Joints& skeletonB,const MD5Joints& skeletonOut,float t) {

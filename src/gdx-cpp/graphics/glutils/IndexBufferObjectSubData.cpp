...
int IndexBufferObjectSubData::createBufferObject () {
    if (gl20 != NULL) {
        ...
        gl20->glBufferData(gdx::GL::ELEMENT_ARRAY_BUFFER, byteBuffer.capacity(), NULL, usage);
        ...
        gl11->glBufferData(gdx::GL::ELEMENT_ARRAY_BUFFER, byteBuffer.capacity(), NULL, usage);

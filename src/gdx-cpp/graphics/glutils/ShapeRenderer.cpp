...
const ShapeRenderer::ShapeType ShapeRenderer::ShapeType::Point(gdx::GL::POINTS);
const ShapeRenderer::ShapeType ShapeRenderer::ShapeType::Line(gdx::GL::LINES);
const ShapeRenderer::ShapeType ShapeRenderer::ShapeType::Rectangle(gdx::GL::LINES);
const ShapeRenderer::ShapeType ShapeRenderer::ShapeType::FilledRectangle(gdx::GL::TRIANGLES);
const ShapeRenderer::ShapeType ShapeRenderer::ShapeType::Box(gdx::GL::LINES);
...
void ShapeRenderer::begin (const ShapeType& type) {
    ...
    if(renderer->getRendererType() == ImmediateModeRenderer::RendererType::IMMEDIATE_GLES10) {
        gl10->glMatrixMode(gdx::GL::PROJECTION);
        gl10->glLoadMatrixf(combined.val);
        gl10->glMatrixMode(gdx::GL::MODELVIEW);
        gl10->glLoadIdentity();

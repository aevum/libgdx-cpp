...
public:
    ...
    virtual   void glGetClipPlanef (int pname,const float*& eqn) = 0;
    virtual   void glGetFloatv (int pname,int offset) = 0;
    virtual   void glGetFloatv (int pname,const float*& params) = 0;
    virtual   void glGetLightfv (int light,int pname,int offset) = 0;
    virtual   void glGetLightfv (int light,int pname,const float*& params) = 0;
    virtual   void glGetMaterialfv (int face,int pname,int offset) = 0;
    virtual   void glGetMaterialfv (int face,int pname,const float*& params) = 0;
    virtual   void glGetTexParameterfv (int target,int pname,int offset) = 0;
    virtual   void glGetTexParameterfv (int target,int pname,const float*& params) = 0;
    ...
    virtual   void glBufferData (int target,int size,const char* data,int usage) = 0;
    virtual   void glBufferSubData (int target,int offset,int size,const char* data) = 0;
    virtual   void glColor4ub (char red,char green,char blue,char alpha) = 0;
    virtual   void glDeleteBuffers (int n,int offset) = 0;
    virtual   void glDeleteBuffers (int n,const int*& buffers) = 0;
    virtual   void glGetBooleanv (int pname,int offset) = 0;
    virtual   void glGetBooleanv (int pname,const int*& params) = 0;
    virtual   void glGetBufferParameteriv (int target,int pname,int offset) = 0;
    virtual   void glGetBufferParameteriv (int target,int pname,const int*& params) = 0;
    virtual   void glGenBuffers (int n,int offset) = 0;
    virtual   void glGenBuffers (int n,const int*& buffers) = 0;
    ...
    virtual   void glGetTexParameteriv (int target,int pname,const int*& params) = 0;
    ...
    virtual   void glPointSizePointerOES (int type,int stride,const char* pointer) = 0;

...
public:
    ...
    virtual void glColorPointer (int size,int type,int stride,const char*& pointer) = 0;
    ...
    virtual   void glFogfv (int pname,const float*& params) = 0;
    ...
    virtual   void glLightModelfv (int pname,const float*& params) = 0;
    virtual   void glLightf (int light,int pname,float param) = 0;
    virtual   void glLightfv (int light,int pname,int offset) = 0;
    virtual   void glLightfv (int light,int pname,const float*& params) = 0;
    ...
    virtual   void glMaterialfv (int face,int pname,const float*& params) = 0;
    ...
    virtual   void glNormalPointer (int type,int stride,const char*& pointer) = 0;
    ...
    virtual   void glTexCoordPointer (int size,int type,int stride,const char*& pointer) = 0;
    virtual   void glTexEnvf (int target,int pname,float param) = 0;
    virtual   void glTexEnvfv (int target,int pname,int offset) = 0;
    virtual   void glTexEnvfv (int target,int pname,const float*& params) = 0;
    virtual   void glTranslatef (float x,float y,float z) = 0;
    virtual   void glVertexPointer (int size,int type,int stride,const char*& pointer) = 0;

...
public:
  ...
  static const int GL_COVERAGE_BUFFER_BIT_NV = 0x8000;
    ...
    virtual   void glDeleteFramebuffers (int n,const int*& framebuffers) = 0;
    virtual   void glDeleteProgram (int program) = 0;
    virtual   void glDeleteRenderbuffers (int n,const int*& renderbuffers) = 0;
    ...
    virtual   void glGenFramebuffers (int n,const int*& framebuffers) = 0;
    virtual   void glGenRenderbuffers (int n,const int*& renderbuffers) = 0;
    virtual   std::string& glGetActiveAttrib (int program,int index,const int*& size,const char* type) = 0;
    virtual   std::string& glGetActiveUniform (int program,int index,const int*& size,const char* type) = 0;
    virtual   void glGetAttachedShaders (int program,int maxcount,const char* count,const int*& shaders) = 0;
    virtual   int glGetAttribLocation (int program,const std::string& name) = 0;
    virtual   void glGetBooleanv (int pname,const char* params) = 0;
    ...
    virtual   void glGetFramebufferAttachmentParameteriv (int target,int attachment,int pname,const int*& params) = 0;
    virtual   void glGetProgramiv (int program,int pname,const int*& params) = 0;
    virtual   std::string& glGetProgramInfoLog (int program) = 0;
    virtual   void glGetRenderbufferParameteriv (int target,int pname,const int*& params) = 0;
    virtual   void glGetShaderiv (int shader,int pname,const int*& params) = 0;
    virtual   std::string& glGetShaderInfoLog (int shader) = 0;
    virtual   void glGetShaderPrecisionFormat (int shadertype,int precisiontype,const int*& range,const int*& precision) = 0;
    virtual   void glGetShaderSource (int shader,int bufsize,const char* length,const std::string& source) = 0;
    ...
    virtual   void glGetUniformfv (int program,int location,const float*& params) = 0;
    virtual   void glGetUniformiv (int program,int location,const int*& params) = 0;
    virtual   int glGetUniformLocation (int program,const std::string& name) = 0;
    virtual   void glGetVertexAttribfv (int index,int pname,const float*& params) = 0;
    virtual   void glGetVertexAttribiv (int index,int pname,const int*& params) = 0;
    virtual   void glGetVertexAttribPointerv (int index,int pname,const char* pointer) = 0;
    ...
    virtual   void glShaderBinary (int n,const int*& shaders,int binaryformat,const char* binary,int length) = 0;
    ...
    virtual   void glVertexAttribPointer (int indx,int size,int type,bool normalized,int stride,const char* ptr) = 0;

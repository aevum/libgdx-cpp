...
public:
    ...
    virtual   void glCompressedTexImage2D (int target,int level,int internalformat,int width,int height,int border,int imageSize,const unsigned char* data) = 0;
    virtual   void glCompressedTexSubImage2D (int target,int level,int xoffset,int yoffset,int width,int height,int format,int imageSize,const unsigned char* data) = 0;
    ...
    virtual   void glDeleteTextures (int n,const int* textures) = 0;
    ...
    virtual   void glDrawElements (int mode,int count,int type,const unsigned char* indices) = 0;
    virtual   void glEnable (int cap) = 0;
    virtual   void glFinish () = 0;
    virtual   void glFlush () = 0;
    virtual   void glFrontFace (int mode) = 0;
    virtual   void glGenTextures (int n,int* textures) = 0;
    virtual   int glGetError () = 0;
    virtual   void glGetIntegerv (int pname,const int* params) = 0;
    ...
    virtual   void glReadPixels (int x,int y,int width,int height,int format,int type,const unsigned char* pixels) = 0;
    ...
    virtual   void glTexImage2D (int target,int level,int internalformat,int width,int height,int border,int format,int type,const unsigned char* pixels) = 0;
    virtual   void glTexParameterf (int target,int pname,float param) = 0;
    virtual   void glTexSubImage2D (int target,int level,int xoffset,int yoffset,int width,int height,int format,int type,const unsigned char* pixels) = 0;

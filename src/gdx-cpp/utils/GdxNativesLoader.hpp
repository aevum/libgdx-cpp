...
public:
    bool loadLibrary (const std::string& nativeFile32,const std::string& nativeFile64);
    std::string& extractLibrary (const std::string& native32,const std::string& native64);
    void load ();

...
float gdx::nix::LinuxInput::getAccelerometerX()
{
    return 0;
}

float gdx::nix::LinuxInput::getAccelerometerY()
{
    return 0;
}

float gdx::nix::LinuxInput::getAccelerometerZ()
{
    return 0;
}

float gdx::nix::LinuxInput::getAzimuth()
{
    return 0;
}

long int gdx::nix::LinuxInput::getCurrentEventTime()
{
    return 0;
}

int gdx::nix::LinuxInput::getDeltaX()
{
    return deltaX;
}

int gdx::nix::LinuxInput::getDeltaX(int pointer)
{
    if (pointer == 0) {
        return deltaX;
    }
...
int gdx::nix::LinuxInput::getDeltaY()
{
    return deltaY;
}

int gdx::nix::LinuxInput::getDeltaY(int pointer)
{
    if (pointer == 0) {
        return deltaY;
    }
...
gdx::Input::Orientation gdx::nix::LinuxInput::getNativeOrientation()
{
...
bool gdx::nix::LinuxInput::isTouched()
{
    return touching;
}

bool gdx::nix::LinuxInput::isTouched(int pointer)
{
    return pointer == 0 && touching;
}

bool gdx::nix::LinuxInput::justTouched()
{
    return _justTouched;
}

void gdx::nix::LinuxInput::setCatchBackKey(bool catchBack)
{

}

void gdx::nix::LinuxInput::setCatchMenuKey(bool catchMenu)
{

}

void gdx::nix::LinuxInput::setCursorCatched(bool catched)
{

}

void gdx::nix::LinuxInput::setCursorPosition(int x, int y)
{

}

void gdx::nix::LinuxInput::setInputProcessor(gdx::InputProcessor* processor)
{
    this->processor = processor;
}

void gdx::nix::LinuxInput::setOnscreenKeyboardVisible(bool visible)
{
}

void gdx::nix::LinuxInput::vibrate(int milliseconds)
{
}

void gdx::nix::LinuxInput::vibrate(long int* pattern, int repeat)
{
}

void gdx::nix::LinuxInput::processEvents(SDL_Event& evt)
{
...
int gdx::nix::LinuxInput::getGdxEventKey(SDL_Event& eventkey) {
...
void gdx::nix::LinuxInput::setKeyboardRepeat(int delay, int repeatInterval)
{

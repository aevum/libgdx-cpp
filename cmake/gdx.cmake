...
macro(gdx_ios_copy_resources target_name target_files destination)
    ...
    add_custom_command(
        TARGET ${target_name}
        POST_BUILD
        COMMAND ${_output}/../../Contents/OtherFrameworks/DevToolsCore.framework/Versions/A/Resources/pbxcp -exclude 
            .DS_Store -exclude CVS -exclude .svn -exclude .git -resolve-src-symlinks ${target_files} ${APP_NAME}/${destination})
endmacro()

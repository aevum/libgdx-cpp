...
#on each backend.
macro(gdx_setup_runnable_target target_name sources additional_libraries) 
	...
	if (APPLE) 
		...
		target_link_libraries(${target_name} ${GDXCPP_LIBRARIES} ${additional_libraries})
	elseif (ANDROID_NDK)
		add_library(${target_name} SHARED ${sources} ${GDXCPP_LIBRARIS})
	
	elseif(UNIX)
		add_executable(${target_name} ${sources} ${GDXCPP_LIBRARIES})
